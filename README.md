...
| Prepare/install an air-gapped release | See [offline packaging](docs/technical/OFFLINE_PACKAGING.md) | Pinned portable Node, llama.cpp, model, checksums, build/start/stop/teardown lifecycle. |
